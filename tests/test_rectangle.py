...
def test_area_of_rectangle(length, breath, result):
...
def test_perimeter_of_rectangle(length, breath, result):
    rectagle_shape = RectangleShape(length, breath)
...
def test_perimeter_of_rectangle_d1(length, breath, result):
    rectagle_shape = RectangleShape(length, breath)
    peri_of_rectangle = rectagle_shape.get_perimeter()
    assert peri_of_rectangle == result
...
def test_perimeter_of_rectangle_d2(length, breath, result):
    rectagle_shape = RectangleShape(length, breath)
    peri_of_rectangle = rectagle_shape.get_perimeter()
    assert peri_of_rectangle == result